...
class UserFilterOverlay extends StatefulWidget {
  final double width;
  final Function(Map<String, dynamic> filterValues)? onSubmitted;

  const UserFilterOverlay({
    super.key,
    required this.width,
    this.onSubmitted,
  });
  ...
  @override
  State<UserFilterOverlay> createState() => _UserFilterOverlayState();
}

class _UserFilterOverlayState extends State<UserFilterOverlay> {
  bool status = true;
